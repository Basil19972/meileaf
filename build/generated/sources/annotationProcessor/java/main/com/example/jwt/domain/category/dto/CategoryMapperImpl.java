...
public class CategoryMapperImpl implements CategoryMapper {
    ...
    public Category fromDTO(CategoryDTO dto) {
        ...
        category.setMin_UserRank_Required( dto.getMin_UserRank_Required() );
        category.setRequired_age( dto.getRequired_age() );
    ...
    public CategoryDTO toDTO(Category BO) {
        ...
        categoryDTO.setMin_UserRank_Required( BO.getMin_UserRank_Required() );
        categoryDTO.setRequired_age( BO.getRequired_age() );
    ...
    @Override
    public Category fromCategoryNameWhitCountDTO(CategoryNameWhitCountDTO dto) {
        if ( dto == null ) {
            return null;
        }
